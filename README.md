...
This algorithm prints mathematical expressions made by {1, 2, 3, ..., 9, -, +} that equal to 100 (e.g. 123 - 45 - 67 + 89 = 100), in an ascending order (<b>NOT</b> <del>1 + 2 - 5 + 6 +79 - 843</del>) and obviously using each number just once.
